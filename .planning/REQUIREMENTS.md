...
- [ ] **AUDIT-05**: Audit-event wiring in `views/*` — Phase 9 owner per the canonical mapping below; Phase 7 Wave 6 makes the writer available (`src/cloud/audit.js` body-filled). Phase 9 will wire view-side call sites.
