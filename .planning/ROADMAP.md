...
- [ ] 09-03-PLAN.md — Wave 3: AUDIT-05 view wiring across 9 sites (src/firebase/auth.js + src/cloud/{claims-admin,gdpr,soft-delete}.js) — pure consumer of enum landed in 09-03a + parity tests (AUDIT-05, OBS-02 partial)
